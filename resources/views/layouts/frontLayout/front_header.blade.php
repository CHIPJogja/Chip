...
<div class="contactinfo">
    <ul class="nav nav-pills">
        <li><a href="#"><i class="fa fa-phone"></i> +62812313141</a></li>
        <li><a href="#"><i class="fa fa-envelope"></i> chip@students.uii.ac.id</a></li>
    </ul>
</div>
</div>
<div class="col-sm-6">
            ...
            <div class="col-sm-8">
                <div class="shop-menu pull-right">
                    <ul class="nav navbar-nav">
                        ...
                        @if(empty(Auth::check()))
                            <li><a href="{{url('/login-register')}}"><i class="fa fa-lock"></i> Masuk</a></li>
                        @else
                            <li><a href="{{url('/account')}}"><i class="fa fa-user"></i> Akun</a></li>
...
<div class="mainmenu pull-left">
    ...
    <li><a href="{{url('/')}}" class="active">Home</a></li>
        ...
        <li><a href="404.html">Tentang Kami</a></li>
